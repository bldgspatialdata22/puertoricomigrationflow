...
- When you filter out the `NA` values for GEOID2, you're excluding migration from Puerto Rico to other continents outside the U.S. That is fine *but* you need to say you're doing that if that is your intent when you further develop the analysis.
